...
var structureUsEnglishLocaleBundle = defineLocaleResourceBundle({
  ...
  resources: () => import("./resources3-WWMRNKYZ.js")
});
...
function SheetListCell(props) {
  const { getValue, column, row, fieldType } = props, initialValue = getValue() || "", [value, setValue] = (0, import_react.useState)(initialValue), handleOnChange = (0, import_react.useCallback)((e) => {
    setValue(e.currentTarget.value);
  }, []);
  return (0, import_react.useEffect)(() => {
    setValue(initialValue || "");
  }, [initialValue]), fieldType.name === "boolean" ? (0, import_jsx_runtime.jsxs)(
    Select,
    {
      radius: 0,
      style: {
  ...
  if (SUPPORTED_FIELDS.includes(type.name)) {
    const nextCol = columnHelper.accessor(
      ...
      parentalField ? `${parentalField}.${field.name}` : field.name,
      {
        ...
        enableHiding: true,
        cell: (info) => (0, import_jsx_runtime.jsx)(SheetListCell, { ...info, fieldType: type })
      }
    );
...
function useDocumentSheetColumns(documentSchemaType) {
  const documentPreviewStore = useDocumentPreviewStore(), columns = (0, import_react.useMemo)(() => documentSchemaType ? [
    columnHelper.display({
      id: "selected",
      enableHiding: false,
      header: (info) => (0, import_jsx_runtime.jsx)(
        Checkbox,
        {
...
function ColumnsControl({ table }) {
  const isVisibleLimitReached = table.getVisibleLeafColumns().filter((col) => col.getCanHide()).length >= VISIBLE_COLUMN_LIMIT, setInitialColumns = (0, import_react.useCallback)(() => {
  ...
  return (0, import_jsx_runtime.jsx)(
    MenuButton,
    {
      button: (0, import_jsx_runtime.jsx)(Button, { text: "Columns" }),
      id: "columns-control",
      menu: (0, import_jsx_runtime.jsxs)(Menu, { padding: 3, paddingBottom: 1, style: { maxHeight: 300, overflow: "scroll" }, children: [
        (0, import_jsx_runtime.jsx)(Button, { size: 0, text: "Reset", onClick: setInitialColumns }),
        (0, import_jsx_runtime.jsxs)(Stack, { children: [
          ...
          isVisibleLimitReached && (0, import_jsx_runtime.jsx)(
            Card,
            {
              padding: 2,
              ...
              shadow: 1,
              tone: "caution",
              children: (0, import_jsx_runtime.jsxs)(Text, { size: 1, children: [
                "You may only have ",
...
function DocumentSheetListPaneInner({
  ...
  const renderRow = (0, import_react.useCallback)((row) => (0, import_jsx_runtime.jsx)(
    Box,
    {
      ...
      children: row.getVisibleCells().map((cell) => (0, import_jsx_runtime.jsx)(
        "td",
        {
          style: {
            display: "flex",
  ...
  return (0, import_jsx_runtime.jsxs)(PaneContainer$1, { direction: "column", paddingX: 3, "data-testid": "document-sheet-list-pane", children: [
    ...
    (0, import_jsx_runtime.jsx)(Flex, { paddingBottom: 3, paddingLeft: 3, children: (0, import_jsx_runtime.jsx)(Text, { size: 0, muted: true, children: rowsCount }) }),
    (0, import_jsx_runtime.jsxs)(TableContainer, { children: [
      (0, import_jsx_runtime.jsx)(ColumnsControl, { table }),
      (0, import_jsx_runtime.jsxs)(Table, { children: [
        (0, import_jsx_runtime.jsx)("thead", { children: table.getHeaderGroups().map((headerGroup) => (0, import_jsx_runtime.jsx)(
          Box,
          {
            as: "tr",
            style: { display: "flex", width: "100%" },
            paddingY: 1,
            children: headerGroup.headers.map((header) => (0, import_jsx_runtime.jsx)("th", { style: { display: "flex", width: header.getSize() }, children: headerGroup.depth > 0 && !header.column.parent ? null : (0, import_jsx_runtime.jsx)("div", { children: flexRender(header.column.columnDef.header, header.getContext()) }) }, header.id))
          },
          headerGroup.id
        )) }),
    ...
    tools: [
      {
        ...
        icon,
        component: (0, import_react.lazy)(() => import("./index3-RHGJ4NZU.js")),
...
@tanstack/react-table/build/lib/index.mjs:
  (**
     ...
     *)
*/
//# sourceMappingURL=chunk-RO6J3C27.js.map
