...
var visionUsEnglishLocaleBundle = defineLocaleResourceBundle({
  ...
  resources: () => import("./resources-CCBWT7ph-66BIPIO7.js")
});
var visionTool = definePlugin((options) => {
  ...
  return {
    ...
    tools: [{
      ...
      component: (0, import_react.lazy)(() => import("./SanityVision-R1OQ_Aqq-PHVO4K5E.js")),
      options: config,
      router: route.create("/*")
    }],
    i18n: {
...
//# sourceMappingURL=chunk-W4QRJ6VK.js.map
